...
conflicts=("$_name")
options=('!debug' '!strip')
_timestamp=202508280529
source=(
    "$_name-$_timestamp.tar.gz::https://prod.download.desktop.kiro.dev/releases/$_timestamp--distro-linux-x64-tar-gz/$_timestamp-distro-linux-x64.tar.gz"
    "$_name.desktop"
    "$_name-url-handler.desktop"
    "$_name-workspace.xml"
)
b2sums=('473c2034416f1897e0311a408ad5e44b85d0a417966824be9d11d6aad2b4ec61d26c50ab7ab9cf0aa97b0d0674d17a3fba1ef44195ab6b8e281b37ced50c495c'
