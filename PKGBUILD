...
options=(!strip)
source=(
    "$_name-202507152342.tar.gz::https://prod.download.desktop.kiro.dev/releases/202507152342--distro-linux-x64-tar-gz/202507152342-distro-linux-x64.tar.gz"
    "$_name.desktop"
    "$_name-url-handler.desktop"
    "$_name-workspace.xml"
)
b2sums=('8d6938e1248e2fd48ac94160ceb0c970f41fb040bd73a8bb09e6a43664bdba0ea950f3b6383d24cbb6178ca0e56ca37c2a7cc78faeb17c8d6381fe96bb06dc03'
